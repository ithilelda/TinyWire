...
// Initialize Class Variables //////////////////////////////////////////////////
	uint8_t TinyWire::USI_Buf[USI_BUF_SIZE];             // holds I2C send and receive data
	uint8_t TinyWire::USI_BufIdx = 0;                    // current number of bytes in the send buff
	uint8_t TinyWire::USI_LastRead = 0;                  // number of bytes read so far
	uint8_t TinyWire::USI_BytesAvail = 0;                // number of bytes requested but not read
